      ...
      >
        ...
        >
          ...
          <Image
            ...
            height={HEIGHT}
            class={`
              absolute rounded-none w-full max-h-full object-cover	
              ${
              !l?.onMouseOver?.image ||
          ...
          {(!l?.onMouseOver?.image ||
            ...
            <Image
              ...
              width={WIDTH}
              height={HEIGHT}
              class="absolute transition-opacity rounded-none w-full max-h-full object-cover opacity-0 lg:group-hover:opacity-100"
              sizes="(max-width: 640px) 50vw, 20vw"
              loading="lazy"
              decoding="async"
            />
